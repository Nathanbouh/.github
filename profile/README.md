...
[Copyleft](https://f.gallai.re/copyleft) est un jeu sérieux qui permet d'appréhender le concept juridique de Copyleft, vous êtes donc invités à y jouer et à faire un screenshot de votre mailleur score à mettre sur le [Wiki](https://github.com/LoLibres/.github/wiki) !
